...
class rundeck::config::global::framework {
  ...
  $__framework_config = merge($_framework_config, $framework_config_url, $framework_config_port)
  $framework_config = merge($__framework_config, $rundeck::framework_config)
